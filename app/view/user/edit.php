                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    <div class="card">
                                        <form class="form-horizontal store-update-entity" action="<?= WEB_ROOT . 'user/update?id=' . arrayGet($data, 'id') ?>" method="post"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" name="username"
                                                                       required
                                                                       value="<?= !empty($_SESSION['data']) ? arrayGet($_SESSION['data'], 'username') : arrayGet($data, 'username') ?>"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="email" class="form-control" name="email"
                                                                       required
                                                                       value="<?=!empty($_SESSION['data']) ? arrayGet($_SESSION['data'], 'email') :  arrayGet($data, 'email') ?>"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="number" class="form-control" name="phone"
                                                                       required
                                                                       value="<?= !empty($_SESSION['data']) ? arrayGet($_SESSION['data'], 'phone') :  arrayGet($data, 'phone') ?>"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" name="address"
                                                                       value="<?= !empty($_SESSION['data']) ? arrayGet($_SESSION['data'], 'address') : arrayGet($data, 'address') ?>"
